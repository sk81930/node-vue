                ...
                try{
                    ...
                    if(result){
                        ...
                        next();
                         ...
                         return response.sendResponse(null, false, "Access denied!", 402);
                    }


                }catch(e){

                   return response.sendResponse(null, false, e.message, 402);
    ...
    hasRole = async (req, res, next, role = null) => {
            ...
            try{
                ...
                if(role){
                    ...
                    return response.sendResponse(null, false, "Role not defined!", 402);
                }
